...
from pytorchmodels.jerseyId.strhub.models.base import CrossEntropySystem, CTCSystem
from pytorchmodels.jerseyId.strhub.models.utils import init_weights
...
class TRBA(CrossEntropySystem):
    ...
    def __init__(self, charset_train: str, charset_test: str, max_label_length: int,
        ...
        named_apply(partial(init_weights, exclude=[
                    'Transformation.LocalizationNetwork.localization_fc2']), self.model)
