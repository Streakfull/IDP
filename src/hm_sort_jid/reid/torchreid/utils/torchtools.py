...
def load_checkpoint(fpath):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import load_checkpoint
...
def resume_from_checkpoint(fpath, model, optimizer=None, scheduler=None):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import resume_from_checkpoint
        >>> fpath = 'log/my_model/model.pth.tar-10'
...
def open_all_layers(model):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import open_specified_layers
...
def count_num_param(model):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import count_num_param
        >>> model_size = count_num_param(model)

    .. warning::

        This method is deprecated in favor of
        ``hm_sort.reid.torchreid.utils.compute_model_complexity``.
    """
    warnings.warn(
...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from hm_sort.reid.torchreid.utils import load_pretrained_weights
