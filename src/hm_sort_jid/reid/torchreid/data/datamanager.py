...
from hm_sort.reid.torchreid.data.sampler import build_train_sampler
from hm_sort.reid.torchreid.data.datasets import init_image_dataset, init_video_dataset
from hm_sort.reid.torchreid.data.transforms import build_transforms
...
class VideoDataManager(DataManager):
    ...
    Examples::
        ...
        datamanager =hm_sort.reid.torchreid.VideoDataManager(
            root='path/to/reid-data',
            sources='mars',
            height=256,
            width=128,
