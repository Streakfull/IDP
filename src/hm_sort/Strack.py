...
from hm_sort import matching
from hm_sort.basetrack import BaseTrack, TrackState
from hm_sort.kalman_filter import KalmanFilter
...
class STrack(BaseTrack):
    ...
    #         cosine_dist = 1 - cosine_sim  # Cosine distance

    #         # Set alpha adaptively
    #         if cosine_dist > 0.3:
    #             alpha = 1.0
    #         else:
    #             alpha = cosine_dist / 0.3  # Inversely proportional scaling
